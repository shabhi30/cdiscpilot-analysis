...
Xanomeline was associated with significantly higher rates of dermatologic events compared to placebo. 
Placebo: 29/86 (34%), 
Xanomeline Low Dose: 62/84 (74%), 
Xanomeline High Dose: 61/84 (73%). 
...
Negative estimates indicate less cognitive decline (improvement) relative to placebo. 
ADAS-Cog is scored where higher = worse, so negative = better.
